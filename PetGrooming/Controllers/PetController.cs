...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult List()
            //Name of this method should match to the name of the view
        {
        ...
        [HttpPost]
        public ActionResult Update(int id,string PetName,int SpeciesID,double Weight, string Color, string Notes)
        {
            string query = "Update pets set PetName=@PetName,SpeciesId=@speciesid, Weight=@Weight, Color=@Color, Notes=@Notes where PetID=@PetID";
            ...
            sqlparams[5] = new SqlParameter("@Notes", Notes);
        ...
        public ActionResult Delete(int id)
        {
            ...
            Pet selectedpet = db.Pets.SqlQuery(query, sqlparams).FirstOrDefault();
